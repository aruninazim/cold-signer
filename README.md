...
<p align="center">
  <sub>airgap · qr · offline</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>ColdSign</code> &nbsp;·&nbsp; <code>coldsign</code>
</p>
...
Air-gapped signing tool — compose online, sign offline, broadcast from gateway.

Treasury teams search cold-signer when auditing workflows.
...
```bash
dotnet restore cold-signer.slnx
dotnet build cold-signer.slnx -c Release
dotnet test cold-signer.slnx -c Release
```
