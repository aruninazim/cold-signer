using ColdSign.App.Commands;
using ColdSign.ChainProviders.Evm;
using ColdSign.ChainProviders.Transport;
using ColdSign.ChainProviders.Utxo;
using ColdSign.Cryptography.Derivation;
using ColdSign.Cryptography.Vault;
using ColdSign.Engine.Analytics;
using ColdSign.Engine.Domain.Contracts;
using ColdSign.Engine.Networks;
using ColdSign.Engine.Options;
using ColdSign.Engine.Orchestration;
using ColdSign.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace ColdSign.App.Bootstrap;
